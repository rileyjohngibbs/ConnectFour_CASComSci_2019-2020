...
class GameScene: SKScene {
    ...
    private func createBoard() {
        ...
        for col in board.columns {
            ...
            playerTurnLabel = SKLabelNode(fontNamed: "ArialRoundMTBold")
    ...
    func changePlayerTurnLabel() {
        if playersTurn == "Red" {
            playersTurn = "Player One"
            playerTurnLabel.fontColor = SKColor.white
        } else if playersTurn == "Black" {
            playersTurn = "Player Two"
            playerTurnLabel.fontColor = SKColor.red
        }
        playerTurnLabel.text = "\(playersTurn)'s Turn"
    }
